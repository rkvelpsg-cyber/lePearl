            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={loading}
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-600 focus:border-transparent outline-none transition-colors disabled:bg-gray-100"
                />
                <button
                  type="button"
