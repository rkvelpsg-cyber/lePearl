...
const overviewPoints = [
  {
    icon: Target,
    text: "Specialised modules for LT Grade Teacher (Prelims + Mains).",
  },
  {
    icon: Video,
  ...
  {
    icon: TrendingUp,
    text: "Moving beyond rote memorisation to deep conceptual understanding is essential for the descriptive nature of the LT Grade Mains.",
  },
];
