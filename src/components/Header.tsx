...
export function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="xl:hidden flex items-center justify-between gap-2 px-2 py-2 min-h-[56px] bg-white">
        {/* Hamburger Button */}
        <button
      ...
      <div
        ref={drawerRef}
        className={`fixed left-0 top-0 h-screen w-64 max-w-[80vw] bg-white shadow-2xl transform transition-transform duration-300 ease-out xl:hidden z-50 overflow-y-auto ${
      ...
      >
        ...
        <nav className="p-4 space-y-1">
          ...
          <DrawerSection label="Online Courses">
            ...
            />
            <DrawerLink href="/courses-set" label="SET" />
          </DrawerSection>
...
function DesktopHeader() {
  ...
  return (
    <div
      className="hidden xl:flex items-center justify-between gap-4 px-8 xl:px-12"
      style={{
        alignItems: "center",
      ...
      >
        ...
        >
          ...
          >
            ...
            <a href="#reviews" style={desktopNavItemStyle}>
              {"Student's Reviews"}
            </a>
            <a href="#mock" style={desktopNavItemStyle}>
              Mock Test
            </a>
            <a href="#books" style={desktopNavItemStyle}>
              Books
            </a>
            <a href="/faculty-registration" style={desktopNavItemStyle}>
              Career
            </a>
            <a
              href="#live-class"
